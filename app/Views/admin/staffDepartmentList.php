            ...
            <div class="widget-content widget-content-area br-6">
                <table class="multi-table table table-striped table-bordered table-hover non-hover" style="width:100%">
                    ...
                    <tbody>
                        ...
                        $staffObj = new StaffDepartment();

                        if(isset($stfDepartments)):
                            $x = 0;
                            foreach($stfDepartments as $staffDpt):
                                $x++;
                                ?>
                                <tr>
                                    <td><?=$x;?></td>
                                    ...
                                    <td><?= $staffDpt->sdp_desc; ?></td>
                                    <td><?= $staffDpt->sdp_created_at;?></td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <?php
                                                ?>
                                                <a class="dropdown-item" href="<?= route_to('staffDepartment.info', $staffDpt->sdp_id); ?>">View</a>
                                                <a class="dropdown-item" href="<?=route_to('stfDepartment.edit', $staffDpt->sdp_id)?>">Edit</a>
