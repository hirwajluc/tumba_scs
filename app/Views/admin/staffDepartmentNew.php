        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
            <div class="widget widget-chart-three">
                <div class="widget-heading">
                    <div class="">
                        <h5 class="">New Staff Department/Unit</h5>
                    </div>
                </div>

                <form action="<?=route_to('staffDepartment.save');?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="invoice-address-company-fields">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" value="<?= (isset($sdp_name)) ? $sdp_name : ''; ?>" name="sdp_name" class="form-control form-control-sm" value="" id="client-name" placeholder="Administration">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <textarea name="sdp_desc" id="" class = "form-control form-control-lg"></textarea>
                                        <?php 
