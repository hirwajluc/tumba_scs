                                ...
                                <tr>
                                    ...
                                    <div class="d-flex">
                                        <div class="usr-img-frame mr-2 rounded-circle">
                                            <img alt="" class="img-fluid rounded-circle" src="<?=$stf->stf_picture;?>">
                                        </div>
                                        <?=$stf->tit_short;?> 
                                        <?=$stf->stf_firstname.' '.$stf->stf_lastname;?>
                                        </p>
                                    </div>
                                    </td>
                                    <td><?=$stf->sdp_name;?></td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <?php
                                                ?>
                                                <a class="dropdown-item" href="<?= route_to('staff.info', $stf->stf_id); ?>">View</a>
                                                <a class="dropdown-item" href="<?=route_to('staff.edit', $stf->stf_id)?>">Edit</a>
